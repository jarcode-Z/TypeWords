...
const siteOrigin = (process.env.ORIGIN || 'http://localhost').replace(/\/$/, '')
    ...
    head: {
      ...
      meta: [
        ...
        //搜索引擎描述
        {
          name: 'description',
          content:
            'Type Words - 在线英语练习平台，支持单词、文章跟打练习，提升英语学习效率，电脑上背单词。Practice English, one strike, one step forward',
        },
        //关键词（可选，搜索引擎基本不用，但能补充信息）
        {
          name: 'keywords',
          content:
            'Type Words, Typing Word, 电脑上背单词 , 英语打字练习, 单词跟打, 文章跟打, 键盘练习, 英语学习, 文章学习, 打字练习软件, 单词记忆工具, 英语学习软件, 背单词神器, 英语肌肉记忆, 键盘工作者, 免费英语学习, 音标发音, 默写练习, 在线学英语, CET-4, CET-6, TOEFL, IELTS, GRE, GMAT, SAT, 考研英语, 专四专八, 程序员英语, JavaScript API, Node.js API, Java API, Linux命令, 编程词汇, 技术英语, VSCode插件, 开源项目, 英语打字训练, WPM统计, 准确率分析, 商务英语, BEC, 雅思听力, 日语学习, 多语言学习, 英语口语练习, 单词拼写训练',
        },
        { name: 'author', content: 'Type Words' },
        { name: 'robots', content: 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' },

        //Open Graph（用于社交媒体分享，微信/QQ/知乎/Facebook 等）
        { property: 'og:title', content: 'Type Words - 英语打字练习平台' },
        {
        ...
        { property: 'og:image', content: toSiteURL('/imgs/og-image.png', appBaseURL) },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },

        // Twitter Card（用于 Twitter 分享）
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Type Words - 英语打字练习平台' },
        {
          name: 'twitter:description',
          content:
            'Type Words - 在线英语练习平台，支持单词、文章跟打练习，提升英语学习效率，电脑上背单词。Practice English, one strike, one step forward',
        },
        { name: 'twitter:image', content: toSiteURL('/imgs/og-image.png', appBaseURL) },
      ...
      script: [
        {
          ...
          innerHTML: JSON.stringify({
            ...
            potentialAction: {
              '@type': 'SearchAction',
              target: `${siteOrigin}/words?q={search_term_string}`,
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            url: `${siteOrigin}/`,
            screenshot: toSiteURL('/imgs/og-image.png', appBaseURL),
            offers: {
              '@type': 'Offer',
              price: '0',
              priceCurrency: 'USD',
